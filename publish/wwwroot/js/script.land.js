...
$(function ($) {
    ...
    $header.css("min-height", h), $("#particles").particleground({
        dotColor: "rgba(205, 205, 205, 0.92)",
        lineColor: "rgba(245, 245, 245, 0.9)",
        minSpeedX: .1,
        maxSpeedX: .2,
        minSpeedY: .1,
        maxSpeedY: .2,
    ...
    $hamburger.on("click touch", function (e) {
        ...
        $(self).width() < 1e3 && ($(this).toggleClass("open-list"), $("#soc-med-list").fadeToggle(200))
    }), $("#footer-1").on("click touch", function () {
        $(self).width() < 1e3 && ($(this).toggleClass("open-list"), $("#footer-1-list").fadeToggle(200))
    }), $("#footer-2").on("click touch", function () {
        $(self).width() < 1e3 && ($(this).toggleClass("open-list"), $("#footer-2-list").fadeToggle(200))
    }), $("#footer-3").on("click touch", function () {
        $(self).width() < 1e3 && ($(this).toggleClass("open-list"), $("#footer-3-list").fadeToggle(200))
    }), $("#footer-4").on("click touch", function () {
        $(self).width() < 1e3 && ($(this).toggleClass("open-list"), $("#footer-4-list").fadeToggle(200))
    }), window.onresize = function (event) {
        $(this).width() >= 1e3 ? ($("#soc-med-list").show(), $("#footer-1-list").show(), $("#footer-2-list").show(), $("#footer-3-list").show(), $("#footer-4-list").show(), $(".open-list").removeClass("open-list")) : ($("#soc-med-list").hide(), $("#footer-1-list").hide(), $("#footer-2-list").hide(), $("#footer-3-list").hide(), $("#footer-4-list").hide())
    }, $("#header-reg-input").on("change keyup paste", function () {
        $.trim(this.value).length ? $("#form-marker-wrap").fadeOut(200) : $("#form-marker-wrap").fadeIn(200)
    }), $("#pulse-container").on("click touch", function (e) {
        e.stopPropagation(), $("#form-hint").toggle(200)
